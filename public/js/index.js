...
function init(pageName) {
  var announcementList = /*#__PURE__*/function (_HTMLElement) {
    ...
    function announcementList() {
      ...
      var widgetTitle = _this.shadowRoot.querySelector('.widget-title');

      widgetTitle.addEventListener('click', function () {
        _this.announcementContainer.classList.toggle('collapsed');

        if (_this.announcementContainer.classList.contains('collapsed')) {
      ...
      value: function appendAnnouncements(announcements) {
        ...
        announcements.forEach(function (announcement) {
          ...
          if (utils.storageAvailable('localStorage')) {
            ...
            var readIndicator = link.querySelector('.read-indicator');
            readIndicator.addEventListener('click', function (e) {
              return _this3.mark(e, link);
            });
          }
        });
      }
  ...
  var CourseOverview = /*#__PURE__*/function (_HTMLElement) {
    ...
    function CourseOverview() {
      ...
      widgetTitle.addEventListener('click', function () {
        ...
        if (_this.shadowRoot.querySelector('.navigator').classList.contains('collapsed')) {
          widgetTitle.querySelector('span').textContent = "+";
        } else {
          widgetTitle.querySelector('span').textContent = "-";
        }
  ...
  var StudyProgress = /*#__PURE__*/function (_HTMLElement) {
    ...
    function StudyProgress() {
      ...
      widgetTitle.addEventListener('click', function () {
        ...
        if (_this.shadowRoot.getElementById('recent-results').classList.contains('collapsed')) {
          widgetTitle.querySelector('span').textContent = "+";
        } else {
          widgetTitle.querySelector('span').textContent = "-";
        }
